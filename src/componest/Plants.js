...
const Plants = () => {
  return (
    <div className=" m-3 ">
        ...
        <div className="col-md-8">
          <div className="card-body pants">
            ...
            <div className="Forbes">
              <h4>Bloomberg</h4> <h4>Forbes</h4>
            </div>
          </div>
        </div>
        <div className="col-md-4">
          <img
            src="./img/unsplash_YAPZt8wxMO4.png"
      ...
      <h6 className="aline d-flex justify-content-center gap-5 mb-5">
        LEARN MORE <img src="./img/Frame 26.png" alt="none"></img>
      </h6>

      <div className="">
        <img
          src="./img/unsplash_ZSZ6wzNU12Q.png"
          className="img-fluid unsplash "
          alt="none"
        />
